package com.playtomic.tests.wallet.shared.infrastructure.bus.command;
...
import com.playtomic.tests.wallet.shared.domain.bus.command.error.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections                          reflections = new Reflections("com.playtomic.tests");
